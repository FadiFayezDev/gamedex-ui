  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        data-side={side}
        // منع الـ Sheet من الإغلاق عند التفاعل مع مودال التريلر
        onPointerDownOutside={(e) => {
          const target = e.target as HTMLElement;
          // بنشيك لو الكليك جوه الـ Container اللي واخد الـ attribute ده أو فيديو
          if (target.closest('[data-trailer-modal]') || target.tagName === 'VIDEO') {
            e.preventDefault();
          }
        }}
        onInteractOutside={(e) => {
          const target = e.target as HTMLElement;
          if (target.closest('[data-trailer-modal]')) {
            e.preventDefault();
          }
        }}
        className={cn(
